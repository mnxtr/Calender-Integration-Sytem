...
\newline \newline
\newline 1. Fetching The Semester-Calendar.
\newline 2. Using Open Source Api to Translate it into CSV/SQL Data. 
\newline3. Restructuring the existing Information According to Google Calender Import structure. 
\newline4. A Script that will run and update any revision. 
